 ...
 */
package com.stackextend.training2.test.setup;
...
import com.stackextend.training2.test.constants.Training2TestConstants;
import com.stackextend.training2.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = Training2TestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/training2test/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/training2test/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/training2test/import/cstickets.impex");
			...
			importImpexFile(context, "/training2test/import/csquotes.impex");
		}
	}
}
