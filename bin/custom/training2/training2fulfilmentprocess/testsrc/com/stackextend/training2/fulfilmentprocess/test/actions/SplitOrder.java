 ...
 */
package com.stackextend.training2.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(Training2FulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(Training2FulfilmentProcessConstants.PARENT_PROCESS);
