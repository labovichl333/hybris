...
public class ProductWarrantyProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider, Serializable {
    ...
    protected List<FieldValue> createFieldValue(final ProductModel product, final IndexedProperty indexedProperty) {
        ...
        final int warrantyYears = getWarrantyYears(product);
