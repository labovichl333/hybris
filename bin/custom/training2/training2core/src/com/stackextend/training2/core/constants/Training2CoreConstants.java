 ...
 */
package com.stackextend.training2.core.constants;

/**
 * Global class for all Training2Core constants. You can add global constants for your extension into this class.
 */
public final class Training2CoreConstants extends GeneratedTraining2CoreConstants
{
	public static final String EXTENSIONNAME = "training2core";


	private Training2CoreConstants()
	{
		//empty
	}
